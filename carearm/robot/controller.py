...
It exposes a tiny, safe vocabulary the skills use: home(), run_policy(), servo_to(),
grip()/release(). Everything else (the judge, skills) goes through this. Keeping the
...
from carearm.types import Point3D
